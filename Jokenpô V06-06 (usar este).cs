...
namespace TrabalhoProgramacao
{
    class Program
    {
        ...
        public static string VencedorRodada, nomeJogador, EscolhaJogador, EscolhaPC;
        ...
        public static void FinaldeJogo()
        {
            ...
            try
            {
                do
                {
                    ...
                    if (FimdeJogo < 0 || FimdeJogo > 3)
                    {
                        Console.WriteLine("Opção inválida, digite 1, 2 ou 3.\n");
                    }
                } while (FimdeJogo < 0 || FimdeJogo > 3);
            }
            ...
            {
                Environment.Exit(-1); //Inserir bagulho de salvar dados aqui
            }
        }
